...
public class BaiHatViewModel : ObservableRecipient
{
    ...
    public BaiHatViewModel(IOAuthTokkenService oAuthTokkenService, INavigationService navigationService, INavigationViewService navigationViewService)
    {
    ...
    public async void getTokkenOnlineBySelenium()
    {
        ...
        //EdgeDriver edge = new EdgeDriver(service, edgeOptions);
        ...
        finally
        {
            ...
            {
                NavigationService.Frame.Navigate(typeof(BaiHatPage), "force refresh after language change");
            }
